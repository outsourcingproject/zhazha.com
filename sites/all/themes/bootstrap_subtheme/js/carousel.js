    ...
    $.fn.kinMaxShow = function (user_options) {
        ...
        var default_options = {
            ...
            button: {
                ...
                //当前 按钮样式
                focus: {background: "#888", border: "1px solid #888", color: "#000000"}
            },
        ...
        k.setLayout = function () {
            ...
            if (options.button.normal.display != 'none') {
                ...
                $(k.self).append('<div class="text-center ' +
                    k.prename + 'button_wrapper' +
                    '"><ul class="' + k.prename + 'button">' + button_list + '</ul></div>');
        ...
        k.setCSS = function () {
            ...
            if (options.button.normal.display != 'none') {
                cssCode += k.selector + ' .' + k.prename + 'button_wrapper{' + k.fn.objToCss(options.button.normal, ['top', 'right', 'bottom', 'left'], true) + ';position:absolute;z-index:2;}';
                cssCode += k.selector + ' .' + k.prename + 'button{list-style:none;overflow:hidden;_zoom:1;display:inline-block;}';
