...
$taxonomy_term_id=$view->args[0];

$taxonomy_term_name=taxonomy_term_load($taxonomy_term_id);
$taxonomy_term_name=$taxonomy_term_name->name;
?>

<ol class="breadcrumb new" >
  <li class="first"><a href="/">渣渣网</a></li>
  <li ><a href="/industry-news" >业界资讯</a></li>
  <li class="active last"><?php print $taxonomy_term_name?></li>
</ol>
  ...
  <article class="article article-industry">
    <div class="row">
      ...
      <div class="col-xs-8">
        ...
        <p class="article-industry-content"><?php print strip_tags($node_body) ?></p>
      </div>
    </div>
