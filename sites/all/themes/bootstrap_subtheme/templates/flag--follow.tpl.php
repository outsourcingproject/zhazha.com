...
?>
  ...
  <div class="<?php print $flag_wrapper_classes; ?>">
    <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="flag-follow-link <?php print $flag_classes ?> action-item j-focus">
      <i class="icon-plus-sign"></i> <?php print $link_text?>
    </a>
  </div>
