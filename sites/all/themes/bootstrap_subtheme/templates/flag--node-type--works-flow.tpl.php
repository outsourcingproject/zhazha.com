...
<div class="<?php print $flag_wrapper_classes;?> works-flow-flag-praise-wrapper">
    <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="flag-praise-link action-item action-praise j-praise <?php print $flag_classes ?>" ><i class="icon-heart"></i><span> <?php print $link_text?></span>	</a>
</div>