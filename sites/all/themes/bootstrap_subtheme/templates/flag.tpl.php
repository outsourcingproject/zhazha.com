...
$flagarr = flag_get_counts('node', $entity_id);
$praiseNum = 0;
...
<?php endif; ?>
  <div class="<?php print $flag_wrapper_classes; ?> flag-praise-wrapper">
    <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?> flag-praise-link " rel="nofollow"><i class=" icon-heart icon-large"></i></a>
    <span class="flag-throbber">&nbsp;</span>
    <div class="flag-praise-times"><?php print $praiseNum?></div>
  </div>
